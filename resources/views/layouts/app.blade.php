            ...
            <div class="w-175 ">
                <nav class="flex items-center justify-between text-xs">
                    <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                        ...
                        <li><a href="" class="text-gray-400 transition duration-500 ease-in border-b-4 pb-3 hover:border-blue">Inprogress(1)</a></li>
                        <li><a href="" class="text-gray-400 transition duration-500 ease-in border-b-4 pb-3 hover:border-blue">Implemented(6)</a></li>
                        <li><a href="" class="text-gray-400 transition duration-500 ease-in border-b-4 pb-3 hover:border-blue">Closed(6)</a></li>
                    </ul>
                </nav>
